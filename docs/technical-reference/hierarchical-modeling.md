...
This document describes the hierarchical Bayesian model for fitting psychometric functions across multiple blocks, consolidating trial-level and points-level fitting approaches into a unified framework.
